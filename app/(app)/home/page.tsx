            ...
            <div className="bg-white rounded-2xl border border-purple-100 px-4 py-3">
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="flex items-center gap-2">
                  <button onClick={handleEndActiveSession} className="text-xs text-warm-gray hover:text-red-400 transition-colors">End</button>
                ...
                <div key={session.id} className="bg-white rounded-2xl border border-amber-100 px-4 py-3">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button onClick={() => handleEndBgSession(session)} className="text-xs text-warm-gray hover:text-red-400 transition-colors">End</button>

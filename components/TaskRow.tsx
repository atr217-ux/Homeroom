  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Right-side controls — grouped in a vertical stack: icon row on top,
            added-at label below (matches the /today CommittedList layout).
            self-start + mt-0.5 anchors to the first line of multi-line text. */}
        ...
        {blockName && (
          ...
          >
            ...
            <span className="max-w-[70px] truncate">{blockName}</span>
          </button>
        )}

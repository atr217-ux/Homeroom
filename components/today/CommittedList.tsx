...
export default function CommittedList({ userId, onOpenSchedule, blockReloadKey }: Props) {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 pt-8 pb-32">
      ...
      {/* Inline "Working on…" widget — sits just under the Focus callout so
          it's easy to glance at while working through today's tasks. */}
      {sessionTask && (
        <div
                ...
                <div>
                  ...
                  >
                    ...
                    >
                      ...
                      {isEditing && (
                        <button onClick={() => setEditingId(null)} className="text-xs flex-shrink-0 px-1 self-start mt-0.5" style={{ color: "var(--text-2)" }}>
                          ✕
                        </button>
                      )}
                    </div>
